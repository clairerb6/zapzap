...
"border-color: transparent;")
    ...
    def retranslateUi(self, PageAbout):
        ...
        self.lblDisclaimer.setText(
            _(
                "This package is an unofficial build. ZapZap original development "
                "and all project credits belong to Rafael Tosta. Legacy package "
                "maintenance (RPM and DEB) is provided independently by this fork."
            )
        )
