...
if __name__ == "__main__":
    ...
    CREATE_RELEASE = os.getenv("CREATE_RELEASE", "false").lower() == "true"
    CHROOTS = [
        chroot.strip()
        for chroot in os.getenv(
            "COPR_CHROOTS",
    ...
    builder = CoprBuilder(
        username=os.getenv("COPR_USERNAME", "rafatosta"),
        project_name=os.getenv("COPR_PROJECT", "zapzap"),
        repo_url=os.getenv("REPO_URL", "https://github.com/rafatosta/zapzap.git"),
